...
{
    public abstract class ShTraceServiceBase : ShAppDataServiceBase
    {
        #region methods
    ...
    public static class ShTraceServiceBaseExtensions
    {
        #region information

        public static void InformationFormat(this ShTraceServiceBase traceService, int id, object message, object parameter)
        {
            InformationFormat(traceService, id, message, new object[] { parameter });
        }

        public static void InformationFormat(this ShTraceServiceBase traceService, int id, object message, object[] parameters)
        {
            InformationFormat(traceService, id, message, parameters, null);
        }

        public static void InformationFormat(this ShTraceServiceBase traceService, int id, object message, object[] parameters, Exception exception)
        {
        ...
        public static void VerboseFormat(this ShTraceServiceBase traceService, int id, object message, object[] parameters)
        {
            if (parameters == null)
        ...
        public static void VerboseFormat(this ShTraceServiceBase traceService, int id, object message, object[] parameters, Exception exception)
        {
        ...
        public static void ErrorFormat(this ShTraceServiceBase traceService, int id, object message, object parameter)
        {
            if (parameter == null)
